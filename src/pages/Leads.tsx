...
import { CardComponent, CustomTable, FormComponent, Header, StyledButton, StyledSpan, StyledP, StyledH2 } from '@/components'
    ...
    if (confirm('Tem certeza que deseja excluir seu Lead?')) {
      try {
        ...
        getLeads()
          ...
          alert('Erro ao deletar o Lead. Entre em contato com nosso suporte.')
        }
    }
  } 
